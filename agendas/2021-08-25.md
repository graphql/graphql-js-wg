...
6. Release plan [`v16.x.x`](https://github.com/graphql/graphql-js/issues/2860) (5m, Ivan)
   1. Updating [`swapi-graphql`](https://github.com/graphql/swapi-graphql)  
   2. Updating [`express-graphql`](https://github.com/graphql/express-graphql)  
7. TS Migration updates `graphql-relay-js#340` (2m, Saihaj)
8. Docs site (2m, Saihaj)
   1. Under what subdomain do we host?
   2. Who to contact for the setup?
