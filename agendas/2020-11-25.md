...
1. Review [16.0.0 Release plan](https://github.com/graphql/graphql-js/issues/2860) and disscuss current state of TS convertion
1. Disscuss support policy for old releases
