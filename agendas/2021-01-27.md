...
| Rob Richard              | 1stDibs                      | New York, NY, USA
...
6. Discuss [`16.0.0`](https://github.com/graphql/graphql-js/issues/2860) todo items status
7. Status update on [`graphql-js`#2828](https://github.com/graphql/graphql-js/pull/2828) review
8. Discuss issue [`graphql-js`#2895](https://github.com/graphql/graphql-js/issues/2895)
