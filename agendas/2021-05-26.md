...
- **Date & Time**: [May 26 2021 17:00 - 20:00 UTC](https://www.timeanddate.com/worldclock/meetingdetails.html?year=2021&month=05&day=26&hour=17&min=0&sec=0&p1=224&p2=179&p3=136&p4=37&p5=239&p6=101&p7=152)
- **Calendar**:
...
| Saihajpreet Singh        | Individual Contributor       | Ottawa, Canada
| Rob Richard              | 1stDibs                      | New York, USA
...
6. [v.16.x.x](https://github.com/graphql/graphql-js/issues/2860) status update and next steps (10m, Ivan)
7. Do we ping contributors to rebase their PRs or if it is a small change we do ourselves? (2m, Saihaj)
   - [`graphql-js#2887`](https://github.com/graphql/graphql-js/pull/2887)
   - [`graphql-js#2984`](https://github.com/graphql/graphql-js/pull/2984)
8. Addressing documentation related issues (2m, Saihaj)
9. Next steps for @defer & @stream (5m, Rob)
