# GraphQL-JS WG – August 2021 (replacement for July 2021 call)
...
- **Date & Time**: [August 04 2021 17:00 - 20:00 UTC](https://www.timeanddate.com/worldclock/meetingdetails.html?year=2021&month=08&day=04&hour=17&min=0&sec=0&p1=224&p2=179&p3=136&p4=37&p5=239&p6=101&p7=152)
- **Calendar**:
...
6. Release Plan `v.16.0.0` [`graphql-js#2860`](https://github.com/graphql/graphql-js/issues/2860)
   1. ESM Support [`graphql-js#3217`](https://github.com/graphql/graphql-js/pull/3217)
7. How can we contribute to post `v16.0.0` enhancements and fixes? 
   1. [graphql-js/milestone/2](https://github.com/graphql/graphql-js/milestone/2)
   2. [graphql-js/milestone/3](https://github.com/graphql/graphql-js/milestone/3)
8.  _ADD YOUR AGENDA ABOVE_
