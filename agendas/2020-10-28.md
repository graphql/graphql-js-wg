...
| Mike Marcacci            | graphql-js to TypeScript     | Woodside, CA
...
1. AsyncIterable and Defer/Stream support (10m, Rob)
   - [Support returning async iterables from resolver functions PR](https://github.com/graphql/graphql-js/pull/2757)
   - [add support for defer and stream directives PR](https://github.com/graphql/graphql-js/pull/2319)
1. Conversion plan for TypeScript
